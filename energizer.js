...
let energizers = [
...

  {
    ...
    body: "This is a simple drama game in which participants take turns asking each other “What are you doing?” and acting out the various responses. Though simple, it engages the imagination and gently challenges participants out of their comfort zone by having them mime a range of different actions. <br> 10-40 people. <br> 5-30 mins. <h4> Step 1: </h4> The group stands in a circle. <h4> Step 2: </h4> One person enters the circle and begins miming an action (e.g. brushing hair or frying an egg). They continue until a another member of the group enters the circle and asks: “What are you doing?” The first person responds by describing any action other that the one she is doing. For example, if she is pretending to brush hair, she might say something like “I’m playing hockey.” The second person must then begin to mime playing hockey. Continue until most or all members have had a chance in the middle. Encourage participants to be creative with the actions.",
  },

  {
    titel: " Dance, Dance, Dance",
    body: "In this short and physically active energizer, participants dance playfully in small teams. Periodically, the music changes and members take turns leading the dance. The aim is to generate fun energy and playfulness in a group, often as a counter-balance to more “serious” group work. <br>10-40 people. <br>5-30 mins. <h4> Step 1: </h4> Organize the group into teams of 3-5 people. <h4> Step 2: </h4> Explain that when the music starts one person in each group starts dancing and the others follow the leaders. When the song changes, another member in each group becomes the new dance leader. Encourage them to be big and crazy with their dance moves and to move around in the space. Change the song every 30 seconds or so. Play enough songs that each member in every group is the leader at least one time. End by fading out the music and initiating a big cheer. <br><span class='boldtext'>Facilitator notes</span> Make sure to choose familiar, highly danceable songs that will energize people right away. Even better if each song is a different genre to mix up the dancing styles. Be mindful that some people may not feel comfortable dancing. Encourage all to participate, but do not put pressure on any who may choose to opt out.",
  },

  {
    titel: "The Viking",
    body: "In this group game, players stand in a circle and perform a series of loud physical moves, passing from one person to the next. When a player hesitates or makes a mistake, he or she is eliminated and the game continues. The game generates laughter and playfulness in the group. <br> 10-40 people.<br> 5-30 mins. <h4> Step 1: </h4> Stand in a circle. One person starts of by shouting 'MJOLNER!!' while making an angry face, a downwards “O” with both arms and bends the knees. The rest of the group follows by copying the movement and the shout. <h4> Step 2: </h4> The MJOLNER-initiator starts air-punching the person to his/her left or right making a loud “HUH” sound. The receiver copies this in the same direction. The receiver’s neighbor can do the same or choose to throw a spell across the middle of the circle to any other group member. This happens by raising the hands above the head and throwing an imaginary item to that person while shouting <span class='boldtext'>“ TUNGUR KNIVUR!’.</span> The receiver across the circle may either continue with a <span class='boldtext'>“HUH”</span> or “ <span class='boldtext'>TUNGUR KNIVUR!’</span> or, he/she may reject the spell, by raising his hands in the air and making a roof shape while shouting <span class='boldtext'>“PAKKA PER!”</span>  Any time a receiver hesitates or uses the wrong words, he or she is out of the game. After a person is kicked out, anyone can start the game again with a new cry of “MJOLNER!” The last person standing is the winner of the game.",
  },

  {
    titel: "The Shouting Game",
    body: "This simple group game is played in a circle. Participants repeatedly choose one other person to look at, hoping that person won’t be looking back at them. Whenever eye contact is made between two participants, both must shout wildly and lunge backward. They are then eliminated. The game generates laughter and boosts energy in a group. <br>10-40 people. <br>5-30 mins. <h4> Step 1: </h4> The group stands shoulder to shoulder in a circle. Everyone must be able to see the eyes of everyone else. Explain that you will be giving two sets of instructions repeatedly, 'heads down' and 'heads up.' When you say 'heads down,' everyone looks at their feet. <h4> Step 2: </h4> When you say 'heads up,' everyone looks up and instantly looks straight at the head of one other person in the circle. There are two possible consequences: when a person looks up at someone who is looking at someone else, nothing happens; when a person looks up at someone who is looking right back at them, they must both point in a very exaggerated manner at the each other and let out a loud SCREAM OR YELL. Those two are then 'out' and stand outside of the circle to observe. Once the 'screamers' have left the circle, the circle closes in and repeat the process until there are only two people left. The final two have to do it one more time, even though the outcome is a foregone conclusion.",
  },
